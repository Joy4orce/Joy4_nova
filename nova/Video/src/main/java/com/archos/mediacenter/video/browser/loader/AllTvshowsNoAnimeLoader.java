...
public class AllTvshowsNoAnimeLoader extends VideoLoader {
    ...
    public AllTvshowsNoAnimeLoader(Context context, boolean applyThrottleDelay, int throttleDelay) {
        this(context, TvshowSortOrderEntries.DEFAULT_SORT, true, applyThrottleDelay, throttleDelay);
    }

    public AllTvshowsNoAnimeLoader(Context context, boolean groupbyOnlineId, boolean applyThrottleDelay, int throttleDelay) {
        this(context, TvshowSortOrderEntries.DEFAULT_SORT, true, applyThrottleDelay, throttleDelay);
    }

    public AllTvshowsNoAnimeLoader(Context context, String SortOrder, boolean showWatched, boolean applyThrottleDelay, int throttleDelay) {
        super(context);
