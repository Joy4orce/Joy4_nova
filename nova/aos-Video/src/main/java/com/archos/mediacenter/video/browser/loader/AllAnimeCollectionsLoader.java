...
public class AllAnimeCollectionsLoader extends VideoLoader {

    private static final String TAG = AllAnimeCollectionsLoader.class.getSimpleName();
    ...
    /**
     * List all anime collections
     * @param context
     */
    public AllAnimeCollectionsLoader(Context context) {
        this(context, CollectionsSortOrderEntries.DEFAULT_SORT, true);
    }

    public AllAnimeCollectionsLoader(Context context, String SortOrder, boolean collectionWatched) {
        super(context);
        mContext = context;
