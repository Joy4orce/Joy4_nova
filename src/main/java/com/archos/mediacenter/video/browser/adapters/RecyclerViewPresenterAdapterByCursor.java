...
public abstract class RecyclerViewPresenterAdapterByCursor extends RecyclerView.Adapter implements  SectionIndexer,
    ...
    public RecyclerViewPresenterAdapterByCursor(Context context, Cursor c) {
        super();
        changeCursor(c);
        mContext = context;
