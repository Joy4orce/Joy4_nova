...
import com.archos.mediacenter.video.browser.loader.AllAnimeCollectionsLoader;
...
public class AllAnimeCollectionsGridFragment extends MyVerticalGridFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static final String SORT_PARAM_KEY = AllAnimeCollectionsGridFragment.class.getName() + "_SORT";

    public static final String ANIME_COLLECTION_WATCHED_KEY = AllAnimeCollectionsGridFragment.class.getName() + "_ANIME_COLLECTION_WATCHED";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int displayModeIndex = mPrefs.getInt(PREF_ANIME_COLLECTION_DISPLAY_MODE, -1);
        if (displayModeIndex<0) {
            mDisplayMode = DisplayMode.GRID; // default
        } else {
            mDisplayMode = DisplayMode.values()[displayModeIndex];
        }
        mSortOrder = mPrefs.getString(SORT_PARAM_KEY, AllAnimeCollectionsLoader.DEFAULT_SORT);
        mSortOrderEntries = CollectionsSortOrderEntry.getSortOrderEntries(getActivity(), sortOrderIndexer);

        mCollectionWatched = mPrefs.getBoolean(ANIME_COLLECTION_WATCHED_KEY, true);

        updateBackground();

        setTitle(getString(R.string.anime_collections));
        setEmptyTextMessage(getString(R.string.you_have_no_anime_collections));
    ...
    private void initGridOrList() {
            ...
            public boolean onLongClick(View v) {
                if (mCollectionsAdapter != null) {
                    ...
                    if (collection != null) {
                        ...
                        LoaderManager.getInstance(AllAnimeCollectionsGridFragment.this).restartLoader(ALL_ANIME_COLLECTIONS_LOADER_ID, args, AllAnimeCollectionsGridFragment.this);
                    }
                }
                return true;
            }
        ...
        args.putString("sort", mSortOrder);
        args.putBoolean("collectionWatched", mCollectionWatched);
        LoaderManager.getInstance(this).restartLoader(ALL_ANIME_COLLECTIONS_LOADER_ID, args, AllAnimeCollectionsGridFragment.this);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getTitleView().setOnOrb2ClickedListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mPrefs.edit().putInt(PREF_ANIME_COLLECTION_DISPLAY_MODE, mDisplayMode.ordinal()).apply();
                // Reload a brand new fragment
                getParentFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new AllAnimeCollectionsGridFragment())
                        .commit();
            }
        });
        ...
        getTitleView().setOnOrb4ClickedListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Save the new setting
                mPrefs.edit().putBoolean(ANIME_COLLECTION_WATCHED_KEY, mCollectionWatched).apply();
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == ALL_ANIME_COLLECTIONS_LOADER_ID) {
            if (args == null) return new AllAnimeCollectionsLoader(getActivity());
            else return new AllAnimeCollectionsLoader(getActivity(), VideoStore.Video.VideoColumns.NOVA_PINNED + " DESC, " + args.getString("sort"), args.getBoolean("collectionWatched"));
        }
        else return null;
    }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        if (cursorLoader.getId() == ALL_ANIME_COLLECTIONS_LOADER_ID) {
